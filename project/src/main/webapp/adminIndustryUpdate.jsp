...
<body>
	...
	<main class="container">
		<h2 class="text-center mb-4">Admin Industry Update</h2>
		<form action="adminindustryupdate" method="post">
					...
					<div class="row">
						<div class="col-md-4 mb-3">
							<label for="typeOfIndustry" class="form-label">Type of
								...
								id="typeOfIndustry" name="typeOfIndustry"
								value="${dto.typeOfIndustry}" required>
						</div>
						<div class="col-md-4 mb-3">
